...
namespace ClasesInstanciables
{
    ...
    public class Alumno : Universitario
    {
        ...
        public Alumno(int id, string nombre, string apellido, string dni, ENacionalidad nacionalidad, EClases claseQueToma, EEstadoCuenta estadoCuenta) : this(id, nombre, apellido, dni, nacionalidad, estadoCuenta)
        {
