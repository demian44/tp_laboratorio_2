...
namespace Entidades_2017
{
    ...
    public class Changuito
    {
        ...
        {
            if (!object.ReferenceEquals(c, null) && !object.ReferenceEquals(p, null) && c._espacioDisponible > 0)
            {
        ...
        public static Changuito operator -(Changuito c, Producto p)
        {
            if (!object.ReferenceEquals(c, null) && !object.ReferenceEquals(p, null) && c._espacioDisponible < 5)
            {
                foreach (Producto v in c._productos)
                {
                    if (v == p)
